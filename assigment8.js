...
const lab = {
    folder: "fotos/",
    // Objetivos: 2.5x (0), 5x (1), 10x (2), 20x (3), 25x (4), 40x (5), 100x (6)
    objectives: [
        "fotos/OBJECTIVE Z 2,5X.JPG", 
        "fotos/OBJECTIVE Z 5X.JPG",   
        "fotos/OBJECTIVE Z 10X.JPG",  
        "fotos/OBJECTIVE Z 20X.JPG",  
        "fotos/OBJECTIVE Z 25X.JPG",
...
function update() {
    ...
    if (currentObj === 2 && currentDC === 0) { // 10x + Fase II
        isCorrect = true;
        technique = "DIC 10x";
    ...
    else if (currentObj === 5 && currentDC === 1) { // 40x + Fase III
        isCorrect = true;
        technique = "DIC 40x";
        selectedSample = "samples/CheekEpithelialCellsDIC40x-3037.czi.png";
    }
    else if (currentObj === 6 && currentDC === 5) { // 100x + Fase D
        isCorrect = true;
        technique = "DIC 100x";
    ...
    else if (currentObj === 6 && currentDC === 6) { 
        isCorrect = true;
        technique = "DICL 100x (Linear)";
        selectedSample = "samples/CheekEpithelialCellsDICL100x-3041.czi copy.jpg";
    }
